...
# set up paths
mrnn_model_path = './cache/models/mscoco/mrnn_GRU_conf/variables/model_25.ckpt'#'./trained_models/coco_caption/mrnn_GRU_570K.ckpt'
mrnn_config_path = './model_conf/mrnn_GRU_conf.py'
mrnn_vocab_path = './cache/dctionary/mscoco_mc3_vocab'
