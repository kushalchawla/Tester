...
# set up paths
mrnn_model_path = './cache/models/mscoco/mrnn_GRU_conf/variables/model_1800.ckpt'#'./trained_models/coco_caption/mrnn_GRU_570K.ckpt'
mrnn_config_path = './model_conf/mrnn_GRU_conf.py'
mrnn_vocab_path = './cache/dctionary/mscoco_mc0_vocab'
...
#                                       flag_from_file=True)
vf_file_name = "tumblr_n8tb4xoSOr1sxfqdyo1_1280"
feat_path = "./cache/mscoco_image_features/inception_v3/train2014/" + vf_file_name +".txt"
